...
if [[ "$1" == apache2* ]] || [ "$1" == php-fpm ]; then
    ...
    # In AWS, pass WORDPRESS_SECRETS environment variable with Secrets Manager content
    # This handles standard 'Credentials for RDS database' secrets content format
